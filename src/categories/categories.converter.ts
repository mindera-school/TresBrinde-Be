...
export class CategoriesConverter {
  static fromCategoryEntityToCategoryDetailsDto(
  ...
  static fromCategoryDetailsDtoToCategoryEntity(
  ...
  static fromSubCategoryEntityToSubCategoryDetailsDto(
    subCategoryEntity: SubCategoryEntity
  ): SubCategoryDetailsDto {
  ...
  static fromSubCategoryDetailsDtoToSubCategoryEntity(
    subCategoryDetailsDto: SubCategoryDetailsDto
  ): SubCategoryEntity {
  ...
  static fromCreateCategoryDtoToCategoryEntity(
  ...
  static fromCreateSubCategoryDtoToSubCategoryEntity(
  ...
  static fromCreateCategoryDtoToSubCategoryEntity(
    createSubCategory: CreateCategoryDto,
    category: CategoryEntity
  ): SubCategoryEntity {
    return new Builder(SubCategoryEntity)
      .with({
